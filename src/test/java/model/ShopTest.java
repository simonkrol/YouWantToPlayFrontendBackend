...
public class ShopTest {
    ...
    public void setUp()
    {
        ...
        Product product1 = new Product("First product", 1, "testPhoto".getBytes(), shop1.getId());
        Product product2 = new Product("Second product", 1, "testPhoto".getBytes(), shop1.getId());
